...
if(strlen($_REQUEST["uname"])==0 || strlen($_REQUEST["pass"])==0 || strlen($_REQUEST["email"])==0){
	...
	$sql="insert into user(`uname`, `firstname`, `lastname`, `password`, `email`, `phone`,`type`) values('".$_REQUEST["uname"]."','".$_REQUEST["firstname"]."','".$_REQUEST["lastname"]."','".$_REQUEST["pass"]."','".$_REQUEST["email"]."','".$_REQUEST["phone"]."', 'customer')";
...
header("Location:../logincontroller/loginCustomer.php");
              ...
              <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../logincontroller/loginCustomer.php">Login</a>
                            </li>
                        </ul>
                    </div>
                </nav>
