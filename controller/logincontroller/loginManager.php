...
$sql="select * from user where uname='".$_REQUEST["uname"]."' and password='".$_REQUEST["pass"]."' and type='manager'";
...
$count = mysqli_num_rows($result);
    ...
    if($flag==1){
       header("Location:../../view/Manager/managerhomepage.html");;
    }
}
?>


<form action="loginManager.php" method="post" onsubmit="return validate()">
<html lang="en">
