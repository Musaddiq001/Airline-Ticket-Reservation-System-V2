...
$count = mysqli_num_rows($result);
    ...
    if($flag==1){
       header("Location:../../view/Agent/agenthomepage.html");;
    }
}
?>
...
<body>
              ...
              <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav">
							...
							<li class="nav-item">
                                <a class="nav-link" href="../../controller/signupcontroller/signupAgent.php">Sign Up</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <form action="loginAgent.php" method="post" onsubmit="return validate()">
